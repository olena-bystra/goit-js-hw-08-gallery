...
const modaleOpen = document.querySelector('.lightbox.js-lightbox');
const imageCurrent = document.querySelector('.lightbox__image');
...
const closeIcon = document.querySelector('button[data-action="close-lightbox"]');
